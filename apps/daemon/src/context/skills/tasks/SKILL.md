...
name: tasks
label: tasks
description: Track durable multi-step work across sessions with the local Aliceloop tracked-task CLI.
status: available
mode: instructional
allowed-tools:
  - bash
...
Use this skill for long-running work that should survive across turns and sessions.
