  ...
  return {
    ...
    describePolicy() {
      ...
      if (context.autoApproveToolRequests) {
        warnings.push("tool approval prompts are auto-approved in this context");
      }
      ...
      if (toolPolicy.permissionProfile === "development") {
        ...
        if (context.autoApproveToolRequests) {
          warnings.push("out-of-policy write, edit, and bash actions continue without a confirmation prompt");
