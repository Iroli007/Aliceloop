...
description: Browse the local Aliceloop skill catalog, inspect skill details, and find the right installed skill for a task.
status: available
mode: instructional
allowed-tools:
  - bash
...
- This catalog covers the local daemon skills only; there is no remote marketplace or third-party install flow.
